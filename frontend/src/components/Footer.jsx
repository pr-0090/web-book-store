  ...
  return (
    <footer className='mb-4'>
      <div className='rounded-tr-3xl rounded-tl-3xl pt-12 xl:pt-20 pb-8'>
        ...
        <p>"Suffering is part of life, but greatness belongs to those who lead with purpose — is that you?"</p>
        ...
        <div className='flex justify-between flex-wrap gap-2
          ...
          <div className='max-w-sm'>
            ...
            <p className='py-4'>Pain itself, it is important to sit with the main purpose of the elite. There is no one to refuse pleasures except ours with delight and rejection?</p>
            <div className='flexBetween pl-3 h-[3rem] bg-primary w-full max-w-[333px] rounded-full ring-1 ring-slate-500/5 mb-4'>
              ...
              <button className='btn-secondaryOne relative right-[24px]'>Press</button>
            </div>
          </div>
      ...
      {/* copyrights */}
      <p className='text-white bg-tertiary medium-14 py-2 px-8 rounded flexBetween '><span>BookStore</span><span>All rights reserved</span></p>
    </footer>
  )
}
